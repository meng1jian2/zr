...
export default {
  ...
  mounted () {
    axios({
      url: `http://m.ziroom.com/v7/room/list.json?city_code=110000&page=1&type=${this.$route.params.value}&price=&face=&rface=&hface=&feature=&around=&leasetype=&tag=&version=&area=&subway_code=&subway_station_code=&district_code=&bizcircle_code=&clng=&clat=&suggestion_type=&suggestion_value=&keywords=&sort=&rapid=`,
      headers: {
